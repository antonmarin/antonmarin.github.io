...
после разбора оказывается что это был чей то эксперимент. Потому и решил 
Написать заметку о том, когда не нужно использовать этот инструмент и какие 
нужны условия если очень хочется.
...
Не нужно использовать если:
 ...
 - На этапе внедрения и разработка не знает как внедрять;
