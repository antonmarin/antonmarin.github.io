...
_Информация, истина о которой находится у бизнеса (Доменного эксперта)_
...
_Хороший код поддерживает динамику внесения изменений с ростом приложения. 
(Сопротивляется эрозии)_
...
* Fail early: Лучше узнать о баге на этапе компиляции, чем когда на него натолкнется пользователь.

## Постройка (не компиляция)

### Цель

_Получить преимущества ценой предварительной обработки кода_
...
* _Убедиться что в процессе внесения изменений мы изменили только желаемое_
* Для модульных: _Упростить написание стабильного кода_ 
...
_Улучшение опыта использования приложения_
