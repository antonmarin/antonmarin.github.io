...
* Придерживаясь подходов, которые используются сообществом или создателями, мы
  ...
  > Например https://datatracker.ietf.org/doc/html/rfc2119 при описании требований
...
Синхронизировать ожидания поставщика и получателя.
...
* Для передачи даты и времени есть широко
  распространенный [ISO8601 RFC3339](https://tools.ietf.org/html/rfc3339#section-5.6)
...
* Логируя разветвления, проще понять поведение в боевой
  среде [PokeMonitor](https://www.rookout.com/blog/the-5-approaches-to-production-debugging/)
...
* Чем чаще код изменяется тем проще с ним
  работать [link](https://martinfowler.com/bliki/FrequencyReducesDifficulty.html)
* Распределенные системы не панацея - у них свои
  недостатки [link](https://en.wikipedia.org/wiki/Fallacies_of_distributed_computing)
...
* Контроль защищенности зависимостей,
  например [roave/security-advisories](https://packagist.org/packages/roave/security-advisories),
