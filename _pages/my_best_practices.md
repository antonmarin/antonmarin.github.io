...
_Хороший код поддерживает динамику внесения изменений с ростом приложения_
...
_Возможность использовать сторонние решения_
...
Разделять сообщения по получателям.
